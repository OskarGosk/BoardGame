...
@Composable
private fun AppGhostButtonLight() =
    BoardGameTheme(darkTheme = false) { AppGhostButtonPreviewContent() }

@Preview(name = "Dark", showBackground = true, backgroundColor = 0xFF131313)
@Composable
private fun AppGhostButtonDark() =
    BoardGameTheme(darkTheme = true) { AppGhostButtonPreviewContent() }
