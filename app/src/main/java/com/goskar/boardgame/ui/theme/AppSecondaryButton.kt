...
@Composable
private fun AppSecondaryButtonLight() = BoardGameTheme(darkTheme = false) { AppSecondaryButtonPreviewContent() }

@Preview(name = "Dark", showBackground = true, backgroundColor = 0xFF131313)
@Composable
private fun AppSecondaryButtonDark() = BoardGameTheme(darkTheme = true) { AppSecondaryButtonPreviewContent() }
