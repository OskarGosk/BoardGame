...
@Composable
private fun AppSectionHeaderLight() = BoardGameTheme(darkTheme = false) { AppSectionHeaderPreviewContent() }

@Preview(name = "Dark", showBackground = true, backgroundColor = 0xFF131313)
@Composable
private fun AppSectionHeaderDark() = BoardGameTheme(darkTheme = true) { AppSectionHeaderPreviewContent() }
