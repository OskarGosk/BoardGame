...
@Composable
private fun AppPrimaryButtonLight() = BoardGameTheme(darkTheme = false) { AppPrimaryButtonPreviewContent() }

@Preview(name = "Dark", showBackground = true, backgroundColor = 0xFF131313)
@Composable
private fun AppPrimaryButtonDark() = BoardGameTheme(darkTheme = true) { AppPrimaryButtonPreviewContent() }
